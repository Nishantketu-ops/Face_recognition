...
def are_histograms_similar(hist1, hist2, threshold=0.8):
...
def detect_faces_and_save_webcam(output_directory, faces_per_second):
...
def capture_image_from_webcam(output_directory, faces_per_second):
    faces_per_second=int(faces_per_second)
    detect_faces_and_save_webcam(output_directory, faces_per_second)
    return "Images saved in folder , Please find it"
# if __name__ == "__main__":
#     output_directory = "Output_directory"
#     print("Press Q to close webcam")
#     detect_faces_and_save_webcam(output_directory, faces_per_second=1)
